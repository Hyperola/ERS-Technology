// src/app/partnerships/financial-institutions/page.tsx
import Link from 'next/link';

export default function FinancialInstitutionsPage() {
  const features = [
    {
      title: "Acquiring Switch Channels",
      desc: "Deep‑pipeline payment integrations supporting banks, POS networks, instant QR, dynamic web checkout setups, and mobile wallets."
    },
    {
      title: "Automated Split Clearing",
      desc: "Smart remittance logic nodes designed to instantly break down composite revenue items and separate baseline taxes from agency fees securely."
    },
    {
      title: "NPL Risk Minimization",
      desc: "Provides automated tracking and structured digital debtor engagement workflows to help institutions reduce non‑performing loans."
    },
    {
      title: "Direct Core‑Banking Integration",
      desc: "Seamless API connectivity to major core banking systems – real‑time reconciliation and automated settlement."
    },
    {
      title: "Multi‑Rail Payment Orchestration",
      desc: "Route transactions across NIBSS, mobile money, card schemes, and alternative payment networks – with smart fallback logic."
    },
    {
      title: "Fraud & Compliance Shield",
      desc: "AI‑powered transaction monitoring, AML/CFT screening, and automated suspicious activity reporting for regulatory compliance."
    }
  ];

  const benefits = [
    "Capture previously unbanked market flows into formal banking channels",
    "Reduce reconciliation time from days to minutes",
    "Lower transaction costs with intelligent payment routing",
    "Strengthen compliance posture with automated AML/KYC tools",
    "Scale fintech integrations without rebuilding core infrastructure"
  ];
  ...
  return (
    <main className="min-h-screen bg-[#F8FAFC] text-[#1C1F61] overflow-x-hidden selection:bg-[#F48B25]/30 selection:text-[#1C1F61] font-['Calibri',Calibri,Segoe_UI,sans-serif]">
      ...
      {/* HERO BANNER – brand colors, unique financial image */}
      <section className="relative bg-[#1C1F61] text-white w-full overflow-hidden flex items-center min-h-[60vh] sm:min-h-0">
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="Financial institutions and fintech integration"
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto px-6 md:px-12 py-12 sm:py-16 md:py-20 lg:py-24">
          <div className="max-w-3xl space-y-4 sm:space-y-5">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight leading-[1.2] text-white">
              ...
              <span className="text-[#F48B25]">Fintech Integrations</span>
            </h1>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-12 sm:py-16 relative z-20 -mt-6 sm:-mt-8">
        <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 md:p-10 shadow-sm hover:shadow-xl transition-all duration-300 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-8 space-y-3">
            <span className="text-xs font-bold text-[#CF1B1B] uppercase tracking-widest">Direct Core‑Banking Rails</span>
            <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-[#1C1F61]">Co‑Developed Settlement Channels</h2>
      ...
      <section className="bg-white py-16 sm:py-20 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 space-y-2">
            <span className="text-[10px] sm:text-xs font-bold text-[#CF1B1B] uppercase tracking-wider">Integration Capabilities</span>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">What Our Financial Platform Delivers</h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4 border-l-4 border-[#F48B25] pl-5">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">Tangible Benefits for Financial Institutions</h2>
              <p className="text-slate-600 text-sm leading-relaxed">
                Extend your reach into informal and underserved markets through our proven revenue infrastructure. Reduce reconciliation costs, capture new transaction volumes, and strengthen compliance – all through a single integration.
              </p>
            </div>
      ...
      {/* WHO WE SERVE – financial sectors */}
      <section className="bg-white py-16 sm:py-20 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-3xl mx-auto mb-12 space-y-2">
            <span className="text-[10px] sm:text-xs font-bold text-[#CF1B1B] uppercase tracking-wider">Deployment Footprint</span>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">Trusted by Financial Partners</h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight">PCI DSS Level 1 & ISO 27001 Certified</h2>
              <p className="text-slate-300 text-sm leading-relaxed">
                Our infrastructure meets the highest security standards in the financial industry. All data is encrypted at rest and in transit, with granular access controls, audit logs, and real‑time fraud monitoring.
              </p>
              <ul className="space-y-2 pt-2">
                <li className="flex items-start gap-2 text-sm text-slate-300">
                  ...
                  Tokenisation and end‑to‑end encryption for sensitive data
                </li>
                <li className="flex items-start gap-2 text-sm text-slate-300">
                  <svg className="w-4 h-4 text-[#F48B25] mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  Automated AML/KYC screening and sanctions list checks
                </li>
                <li className="flex items-start gap-2 text-sm text-slate-300">
                  <svg className="w-4 h-4 text-[#F48B25] mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 sm:p-8">
              <div className="space-y-4">
                <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                  ...
                  <div>
                    <h4 className="font-bold">Regulatory Compliance Ready</h4>
                    <p className="text-xs text-slate-400">CBN, NDPR, and international standards</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-bold">Fast Onboarding & Go‑Live</h4>
                    <p className="text-xs text-slate-400">Typical integration: 2–4 weeks from sign‑off</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto px-6 md:px-12">
          <div className="bg-gradient-to-br from-[#1C1F61] to-[#2a2e7a] text-white rounded-2xl sm:rounded-[2rem] p-6 sm:p-8 md:p-12 text-center space-y-5">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-extrabold tracking-tight max-w-2xl mx-auto leading-tight">
              Deploy Robust Transaction Processing Nodes
            </h2>
            <p className="text-slate-300 max-w-2xl text-xs sm:text-sm md:text-base leading-relaxed mx-auto">
              Partner with ERS to co‑locate acquiring switches, unify payment rails, and build high‑efficiency liquidation grids. Join leading financial institutions already powering their growth through our infrastructure.
            </p>
