// src/app/partnerships/government/page.tsx
...
export default function GovernmentPartnershipsPage() {
  const features = [
    {
      step: "01",
      title: "Digital Taxpayer Profiling",
      desc: "Comprehensive digital taxpayer registration, enumeration, and identity profiling tools that clean up government assessment records."
    },
    {
      step: "02",
      title: "Real‑Time Reporting",
      desc: "Centralised executive dashboards tracking all collections instantly, providing a transparent audit trail that mitigates localised revenue skimming."
    },
    {
      step: "03",
      title: "Enforcement Infrastructure",
      desc: "Electronic receipting, digital verification systems, and field enforcement tools that guarantee payment accountability across public nodes."
    },
    {
      step: "04",
      title: "Automated Reconciliation",
      desc: "Match every payment to the correct taxpayer, invoice, and bank account – no manual effort, ready for auditor oversight."
    },
    {
      step: "05",
    ...
    },
    {
      ...
      desc: "Empower your team with on‑site training, documentation, and ongoing support – maximise platform adoption and impact."
    }
  ];
  ...
  const benefits = [
    ...
    "Real‑time visibility across all collection points and MDAs",
  ...
  return (
    <main className="min-h-screen bg-[#F8FAFC] text-[#1C1F61] overflow-x-hidden selection:bg-[#F48B25]/30 selection:text-[#1C1F61] font-['Calibri',Calibri,Segoe_UI,sans-serif]">
      ...
      {/* HERO BANNER – brand colors, unique government partnership image */}
      <section className="relative bg-[#1C1F61] text-white w-full overflow-hidden flex items-center min-h-[60vh] sm:min-h-0">
        <div className="absolute inset-0 z-0">
          <img 
            src="https://images.unsplash.com/photo-1541872703-74c5e44368f9?q=80&w=2070"
            alt="Government and public sector partnership"
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto px-6 md:px-12 py-12 sm:py-16 md:py-20 lg:py-24">
          <div className="max-w-3xl space-y-4 sm:space-y-5">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight leading-[1.2] text-white">
              Government & <br />
              <span className="text-[#F48B25]">Public Sector Partnerships</span>
            </h1>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-12 sm:py-16 relative z-20 -mt-6 sm:-mt-8">
        <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 md:p-10 shadow-sm hover:shadow-xl transition-all duration-300 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-8 space-y-3">
            <span className="text-xs font-bold text-[#CF1B1B] uppercase tracking-widest">Maximising Sovereign IGR</span>
            <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-[#1C1F61]">Expand the Net, Eliminate the Leakages</h2>
      ...
      <section className="bg-white py-16 sm:py-20 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 space-y-2">
            <span className="text-[10px] sm:text-xs font-bold text-[#CF1B1B] uppercase tracking-wider">Partnership Capabilities</span>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">What Our Government Platform Delivers</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
            {features.map((feature, idx) => (
              <div key={idx} className="group p-5 bg-white rounded-xl border border-slate-200/60 shadow-sm hover:shadow-xl hover:border-[#F48B25]/30 transition-all">
                <div className="text-xs font-bold text-[#F48B25] tracking-wider uppercase mb-2">{feature.step}</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4 border-l-4 border-[#F48B25] pl-5">
              ...
              <p className="text-slate-600 text-sm leading-relaxed">
                Replace fragmented, manual collection systems with a unified, transparent, and auditable digital platform. Boost IGR, eliminate leakages, and restore citizen trust through modern revenue administration.
              </p>
            </div>
        ...
        <div className="max-w-5xl mx-auto px-6 md:px-12">
          <div className="bg-gradient-to-br from-[#1C1F61] to-[#2a2e7a] text-white rounded-2xl sm:rounded-[2rem] p-6 sm:p-8 md:p-12 text-center space-y-5">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-extrabold tracking-tight max-w-2xl mx-auto leading-tight">
              Ready to Modernise Your Government Revenue?
            </h2>
