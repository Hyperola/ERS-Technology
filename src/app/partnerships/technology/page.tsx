  ...
  return (
    <main className="min-h-screen bg-[#F8FAFC] text-[#0A2540] overflow-x-hidden selection:bg-[#E5981A]/30 selection:text-[#0A2540] font-['Calibri',Calibri,Segoe_UI,sans-serif]">
      ...
      <section className="relative bg-[#0A2540] text-white py-24 px-6 md:px-12 lg:px-24 flex flex-col justify-center min-h-[50vh] overflow-hidden text-left">
        <div className="absolute inset-0 bg-cover bg-center mix-blend-luminosity opacity-15 scale-105" style={{ backgroundImage: `url('https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?q=80&w=2000')` }} />
        ...
        <div className="max-w-5xl space-y-6 relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight leading-[1.1]">
            ...
            <span className="text-[#E5981A]">Technology Infrastructure</span>
          </h1>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white border border-slate-200 p-8 md:p-12 rounded-3xl shadow-xl text-left grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-8 space-y-3">
              <span className="text-xs font-bold text-[#A62626] uppercase tracking-widest">Next-Generation Engineering</span>
              <h2 className="text-3xl font-bold tracking-tight">Scalable Cloud Architectures</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            <div className="bg-white border border-slate-200 p-8 rounded-2xl shadow-lg space-y-4">
              <h3 className="font-bold text-lg text-[#0A2540]">Flexible API Ecosystem</h3>
              <p className="text-slate-500 text-sm leading-relaxed">
                Developer-centric endpoints and connectivity frameworks allowing secure synchronization with external accounting ledgers and core agency monitors.
              </p>
            </div>
            <div className="bg-white border border-slate-200 p-8 rounded-2xl shadow-lg space-y-4">
              <h3 className="font-bold text-lg text-[#0A2540]">Predictive AI Analytics</h3>
              <p className="text-slate-500 text-sm leading-relaxed">
                Integrated artificial intelligence tracking pattern variances, structural compliance shifts, and automated asset reconciliation flows.
              </p>
            </div>
            <div className="bg-white border border-slate-200 p-8 rounded-2xl shadow-lg space-y-4">
              <h3 className="font-bold text-lg text-[#0A2540]">Hardened Security Layer</h3>
              <p className="text-slate-500 text-sm leading-relaxed">
                Multi-layer encryption models and strict database partition schemes protecting financial data assets from external vulnerability exposures.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#0A2540] text-white p-8 md:p-12 rounded-3xl text-center space-y-6 relative overflow-hidden">
            <div className="relative z-10 max-w-2xl mx-auto space-y-3">
              <h3 className="text-2xl font-bold">Co-Build the Future of Financial Networks</h3>
              <p className="text-slate-300 text-sm">Integrate your core system software architectures with Africa’s emerging revenue infrastructure platform.</p>
              <div className="pt-4">
