...
export default function InternationalDevelopmentPartnersPage() {
  return (
      ...
      <section className="relative bg-[#0A2540] text-white py-24 px-6 md:px-12 lg:px-24 flex flex-col justify-center min-h-[50vh] overflow-hidden text-left">
        ...
        <div className="max-w-5xl space-y-6 relative z-10">
          <div className="inline-flex items-center gap-2 border border-[#E5981A]/30 bg-white/5 backdrop-blur-sm px-4 py-2 rounded-full text-xs font-bold tracking-widest text-[#E5981A] uppercase">
            CONTINENTAL ECONOMIC ROADS
          </div>
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight leading-[1.1]">
            International Development & <br />
            <span className="text-[#E5981A]">Multilateral Alliances</span>
          </h1>
          <p className="text-slate-200 text-lg md:text-xl max-w-3xl leading-relaxed font-normal">
            Partnering with pan-African agencies and global organizations to expand infrastructure metrics, enhance transparency, and stimulate growth.
          </p>
        </div>
      </section>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white border border-slate-200 p-8 md:p-12 rounded-3xl shadow-xl text-left grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-8 space-y-3">
              <span className="text-xs font-bold text-[#A62626] uppercase tracking-widest">Macro-Economic Evolution</span>
              <h2 className="text-3xl font-bold tracking-tight">Sustainable Infrastructure Solutions for Africa</h2>
              <p className="text-slate-600 text-sm md:text-base leading-relaxed">
                ERS provides a scalable foundation for modern digital growth. By deploying transparent financial frameworks, we assist development agencies in mapping out informal economic systems and converting raw transactional activities into structured growth matrices.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
            <div className="bg-white border border-slate-200 p-8 rounded-2xl shadow-lg space-y-4">
              <h3 className="font-bold text-lg text-[#0A2540]">Financial Inclusion Layouts</h3>
              <p className="text-slate-500 text-sm leading-relaxed">
                Onboarding informal market participants and small-scale transit operators into formal digital networks, providing verifiable identity histories.
              </p>
            </div>
            <div className="bg-white border border-slate-200 p-8 rounded-2xl shadow-lg space-y-4">
              <h3 className="font-bold text-lg text-[#0A2540]">Systemic Accountability Grids</h3>
              <p className="text-slate-500 text-sm leading-relaxed">
                Automated remittance rails and immutable transaction matching systems that reduce administrative leakages and satisfy international operational standards.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#0A2540] text-white p-8 md:p-12 rounded-3xl text-center space-y-6 relative overflow-hidden">
            <div className="relative z-10 max-w-2xl mx-auto space-y-3">
              <h3 className="text-2xl font-bold">Accelerate Sustainable African Development</h3>
              <p className="text-slate-300 text-sm">Collaborate with ERS to scale accountable governance systems across developing municipal structures.</p>
              <div className="pt-4">
                <Link href="/partnerships/become-a-partner" className="inline-block bg-[#E5981A] hover:bg-[#f5a92a] text-[#0A2540] font-bold text-xs uppercase tracking-wider px-8 py-4 rounded-xl shadow-md transition-all">
                  Connect as Multilateral Partner
                </Link>
              </div>
            </div>
          </div>
