// src/app/ecosystem/government-revenue/page.tsx
...
export default function GovernmentRevenueEcosystemPage() {
  ...
  const features = [
    {
      title: "Automated Tax & Levy Billing",
      desc: "Generate and dispatch digital invoices for property tax, business levies, development fees, and more – with automated reminders."
    },
    {
      title: "Citizen Self‑Service Portal",
      desc: "Enable taxpayers to view bills, make payments, download receipts, and raise disputes online – 24/7."
    },
    {
      title: "Field Collection Apps",
      desc: "Equip local government field officers with secure mobile apps to collect payments offline and sync automatically."
    },
    {
      title: "Executive Dashboards",
      desc: "Real‑time visualisation of collections by region, revenue head, and agent – drill down to transaction level."
    },
    {
      title: "Automated Reconciliation",
      desc: "Match every payment to the correct taxpayer, invoice, and bank account – no manual effort."
    },
    {
      title: "Compliance & Enforcement Tools",
      desc: "Identify defaulters, generate penalty notices, and trigger automated enforcement workflows."
    }
  ];
  ...
  const benefits = [
    ...
    "Automated reporting for auditors and oversight committees"
  ];
  ...
  return (
    <main className="min-h-screen bg-[#F8FAFC] text-[#1C1F61] overflow-x-hidden selection:bg-[#F48B25]/30 selection:text-[#1C1F61] font-['Calibri',Calibri,Segoe_UI,sans-serif]">
      ...
      {/* HERO BANNER – brand colors, reliable government revenue image */}
      <section className="relative bg-[#1C1F61] text-white w-full overflow-hidden flex items-center min-h-[60vh] sm:min-h-0">
        <div className="absolute inset-0 z-0">
          <img 
            src="https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?q=80&w=2070"
            alt="Government revenue management"
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto px-6 md:px-12 py-12 sm:py-16 md:py-20 lg:py-24">
          <div className="max-w-3xl space-y-4 sm:space-y-5">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight leading-[1.2] text-white">
              ...
              <span className="text-[#F48B25]">Management Services</span>
            </h1>
            <p className="text-slate-200 text-sm sm:text-base md:text-lg max-w-3xl leading-relaxed">
              Helping states, local government councils, and federal agencies eliminate cash leakages, organise citizen records, and rebuild public trust.
            </p>
      ...
      {/* THREE PILLARS – original categories (government ecosystem sectors) */}
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-12 sm:py-16 relative z-20 -mt-6 sm:-mt-8">
        <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 lg:p-10 shadow-sm hover:shadow-xl transition-all duration-300">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 text-left divide-y lg:divide-y-0 lg:divide-x divide-slate-100">
            {categories.map((item, idx) => (
              <div key={idx} className="pt-6 lg:pt-0 lg:px-6 first:pl-0 last:pr-0 space-y-3">
                <span className="text-[10px] font-bold text-[#F48B25] uppercase tracking-wider block">SUPPORTED DEPARTMENT // 0{idx+1}</span>
                <h3 className="text-lg sm:text-xl font-bold text-[#1C1F61] tracking-tight">{item.title}</h3>
                <p className="text-slate-500 text-xs sm:text-sm leading-relaxed">{item.detail}</p>
              </div>
            ))}
          </div>
      ...
      <section className="bg-white py-16 sm:py-20 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 space-y-2">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">What Our Revenue Platform Delivers</h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4 border-l-4 border-[#F48B25] pl-5">
              <span className="text-[10px] sm:text-xs font-bold text-[#CF1B1B] uppercase tracking-wider">Why Digitise Government Revenue?</span>
