// src/app/ecosystem/transport/page.tsx
import Link from 'next/link';

export default function TransportEcosystemPage() {
  const features = [
    {
      title: "Quick Ticket Scanning",
      desc: "Handheld payment devices and smartphone scanners allow drivers and conductor teams to check customer tickets quickly, even when there is absolutely no phone network or internet access on the road."
    },
    {
      title: "Fair & Automatic Earnings Splitting",
      desc: "Our platform automatically calculates ticket payments and separates the money into different accounts, sending correct shares straight to vehicle owners, local unions, and government agencies instantly."
    },
    {
      title: "Offline‑First Validation",
      desc: "Validate tickets and process transactions even in dead zones – data syncs automatically when connectivity returns, ensuring zero revenue loss."
    },
    {
      title: "Real‑Time Fleet Monitoring",
      desc: "Track bus locations, passenger counts, and revenue per trip on a live dashboard – optimise routes and reduce operating costs."
    },
    {
      title: "Union & Operator Portals",
      desc: "Separate logins for unions, fleet owners, drivers, and government regulators – each sees only the data they need."
    },
    {
  ...
  const benefits = [
    ...
    "Real‑time visibility into collections and utilisation",
    "Automatic reconciliation – no manual counting",
    "Build public trust with transparent, verifiable records"
  ];
  ...
  return (
    <main className="min-h-screen bg-[#F8FAFC] text-[#1C1F61] overflow-x-hidden selection:bg-[#F48B25]/30 selection:text-[#1C1F61] font-['Calibri',Calibri,Segoe_UI,sans-serif]">
      ...
      {/* HERO BANNER – brand colors, reliable transit image */}
      <section className="relative bg-[#1C1F61] text-white w-full overflow-hidden flex items-center min-h-[60vh] sm:min-h-0">
        <div className="absolute inset-0 z-0">
          <img 
            src="https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?q=80&w=2070"
            alt="Public transport system"
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto px-6 md:px-12 py-12 sm:py-16 md:py-20 lg:py-24">
          <div className="max-w-3xl space-y-4 sm:space-y-5">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight leading-[1.2] text-white">
              Smart Travel & <br />
              <span className="text-[#F48B25]">Transit Systems</span>
            </h1>
            <p className="text-slate-200 text-sm sm:text-base md:text-lg max-w-3xl leading-relaxed">
              Making transport collections simpler with cashless tickets, secure card scanning, and clear payment splitting for owners and unions – online or offline.
            </p>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-12 sm:py-16 relative z-20 -mt-6 sm:-mt-8">
        <div className="bg-white border border-slate-200 p-6 sm:p-8 md:p-10 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-8 space-y-3">
            <span className="text-xs font-bold text-[#CF1B1B] uppercase tracking-widest">Better Ways to Move</span>
            <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-[#1C1F61]">Connected Transport Systems</h2>
      ...
      {/* FEATURES GRID – 6 key capabilities (original 2 + 4 new) */}
      <section className="bg-white py-16 sm:py-20 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 space-y-2">
            <span className="text-[10px] sm:text-xs font-bold text-[#CF1B1B] uppercase tracking-wider">Transit Capabilities</span>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4 border-l-4 border-[#F48B25] pl-5">
              <span className="text-[10px] sm:text-xs font-bold text-[#CF1B1B] uppercase tracking-wider">Why Digital Transit?</span>
