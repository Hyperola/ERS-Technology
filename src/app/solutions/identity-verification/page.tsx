...
export default function IdentityVerificationPage() {
  const features = [
    {
      title: "Biometric Operator Registration",
      desc: "Capture fingerprints, facial data, and digital signatures for field agents – eliminates ghost workers and identity fraud."
    },
    {
      title: "QR‑Embedded Smart Cards",
      desc: "Issue tamper‑proof smart cards with embedded QR codes for quick verification and automated transaction logging."
    },
    {
      title: "Automated KYC & AML Checks",
      desc: "Real‑time verification against national registries, watchlists, and credit bureaus – fully automated onboarding."
    },
    {
      title: "Self‑Service Onboarding Portal",
      desc: "Agents register themselves via web or USSD, upload documents, and complete identity verification remotely."
    },
    {
      title: "Central Identity Registry",
      desc: "Single source of truth for all operators, merchants, and field agents – with role‑based access controls."
    },
    {
      title: "Audit‑Ready Activity Logs",
      desc: "Every identity verification, login attempt, and card swipe is logged with timestamp and geolocation."
    }
  ];

  const benefits = [
    "Eliminate ghost workers and unauthorised agents",
    "Reduce onboarding time from weeks to hours",
    "Real‑time visibility into operator compliance status",
    "Prevent identity fraud and duplicate registrations",
    "Seamless integration with revenue collection systems"
  ];

  const servedSectors = [
    "Transport Unions & Driver Associations",
  ...
  return (
    <main className="min-h-screen bg-[#F8FAFC] text-[#1C1F61] overflow-x-hidden selection:bg-[#F48B25]/30 selection:text-[#1C1F61] font-['Calibri',Calibri,Segoe_UI,sans-serif]">
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto px-6 md:px-12 py-12 sm:py-16 md:py-20 lg:py-24">
          <div className="max-w-3xl space-y-4 sm:space-y-5">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight leading-[1.2] text-white">
              ...
              <span className="text-[#F48B25]">Registry Systems</span>
            </h1>
      ...
      {/* CORE DESCRIPTION CARD + FEATURE LIST – two‑column layout */}
            ...
            <div className="lg:col-span-7 bg-white border border-slate-200 p-6 sm:p-8 rounded-2xl shadow-sm hover:shadow-xl hover:border-[#F48B25]/40 transition-all duration-300 hover:-translate-y-1">
              <div className="space-y-4">
                ...
                <p className="text-slate-600 text-sm leading-relaxed">
                  True transaction visibility is impossible without clear operator identity tracking. Our system runs automated identity checks that convert anonymous informal operators into verified, authorised actors within your digital platform network.
                </p>
              </div>
              <div className="mt-6 border-t border-slate-100 pt-5">
                <div className="bg-[#F8FAFC] border border-slate-200/60 p-4 rounded-xl text-xs font-mono text-[#1C1F61] font-bold tracking-tight">
                  SECURE KYC CHECKLIST INTEGRATED VIA NATIONAL REGISTRIES
                </div>
              </div>
            </div>

            {/* Side Feature List & CTA */}
            <div className="lg:col-span-5 bg-white border border-slate-200 p-6 sm:p-8 rounded-2xl shadow-sm hover:shadow-xl hover:border-[#F48B25]/40 transition-all duration-300 hover:-translate-y-1 flex flex-col justify-between">
              <div className="space-y-4">
                ...
                <ul className="space-y-3 text-xs text-slate-600">
                  <li className="flex items-center gap-2"><span className="text-[#F48B25] font-bold text-sm">✓</span> Automated Biometric Operator Logs</li>
                  <li className="flex items-center gap-2"><span className="text-[#F48B25] font-bold text-sm">✓</span> QR‑Embedded Smart Merchant Cards</li>
                  <li className="flex items-center gap-2"><span className="text-[#F48B25] font-bold text-sm">✓</span> Persistent Field Auditing History Traceability</li>
                </ul>
              </div>
              <div className="mt-6 border-t border-slate-100 pt-5">
      ...
      <section className="bg-white py-16 sm:py-20 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 space-y-2">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">What Our Identity Platform Delivers</h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4 border-l-4 border-[#F48B25] pl-5">
              <span className="text-[10px] sm:text-xs font-bold text-[#CF1B1B] uppercase tracking-wider">Why Digitise Identity?</span>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">Tangible Benefits for Administrators</h2>
              <p className="text-slate-600 text-sm leading-relaxed">
                Stop relying on paper records and manual verification. Our identity registry gives you real‑time visibility into every operator, agent, and merchant – with full audit trails.
              </p>
            </div>
      ...
      <section className="bg-white py-16 sm:py-20 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-3xl mx-auto mb-12 space-y-2">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">Trusted by Operator Networks Nationwide</h2>
          </div>
      ...
      {/* TECHNICAL HIGHLIGHTS – biometric & security */}
      <section className="bg-[#1C1F61] text-white py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4">
              <span className="text-xs font-bold text-[#F48B25] uppercase tracking-wider">Biometric‑Grade Security</span>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight">Verify Once, Trust Always</h2>
              <p className="text-slate-300 text-sm leading-relaxed">
                Our identity platform captures multiple biometric factors (fingerprint, facial recognition) and cross‑references them with national databases. Once verified, operators receive a tamper‑proof digital identity that follows them across all revenue collection activities.
              </p>
              <ul className="space-y-2 pt-2">
                ...
                <li className="flex items-start gap-2 text-sm text-slate-300">
                  ...
                  Offline verification mode for remote locations
                </li>
                <li className="flex items-start gap-2 text-sm text-slate-300">
                  <svg className="w-4 h-4 text-[#F48B25] mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  Automated sync with central revenue dashboards
                </li>
              </ul>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400">NDPR and GDPR‑ready data handling</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-bold">Unified Registry</h4>
                    <p className="text-xs text-slate-400">Single source of truth across all agencies</p>
                  </div>
                </div>
              </div>
            </div>
