...
export default function PaymentInfrastructurePage() {
  ...
  const features = [
    {
      ...
      desc: "Single API integration for all payment channels – banks, mobile money, cards, and QR – with automatic failover and routing."
    },
    {
      title: "Real-Time Settlement Engine",
      desc: "Instant reconciliation across multiple acquirers and payment methods. Funds move directly to institutional accounts with full audit trails."
    },
    {
      title: "Fraud & Risk Management",
      desc: "AI‑driven transaction monitoring, velocity checks, and anomaly detection to prevent revenue leakage and chargebacks."
    },
    {
      title: "White‑Label Payment Links",
      desc: "Generate branded payment URLs, invoices, and checkout pages – no development required for merchants."
    },
    {
      title: "Automated Tax Deduction at Source",
      desc: "Configure platform rules to automatically deduct levies, taxes, or commissions before settlement to principals."
    },
    {
      title: "Developer‑Friendly APIs",
      desc: "Comprehensive documentation, sandbox environment, and webhooks for seamless integration with existing systems."
    }
  ];

  const benefits = [
    "Reduce reconciliation time from days to seconds",
    "Eliminate manual entry errors and fraud",
    "Accept payments via any channel – online, offline, USSD, POS",
    "Automatic tax / levy deduction before settlement",
    "Scale to millions of transactions without downtime"
  ];
  ...
  return (
    <main className="min-h-screen bg-[#F8FAFC] text-[#1C1F61] overflow-x-hidden selection:bg-[#F48B25]/30 selection:text-[#1C1F61] font-['Calibri',Calibri,Segoe_UI,sans-serif]">
      ...
      <section className="relative bg-[#1C1F61] text-white w-full overflow-hidden flex items-center min-h-[60vh] sm:min-h-0">
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="Digital payment infrastructure"
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto px-6 md:px-12 py-12 sm:py-16 md:py-20 lg:py-24">
          <div className="max-w-3xl space-y-4 sm:space-y-5">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight leading-[1.2] text-white">
              ...
              <span className="text-[#F48B25]">Multi‑Channel Core</span>
            </h1>
      ...
      {/* CONNECTIVITY NODES GRID – 6 core integrations */}
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 space-y-2">
            <span className="text-[10px] sm:text-xs font-bold text-[#CF1B1B] uppercase tracking-wider">Omnichannel Coverage</span>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">Connect Any Payment Channel</h2>
            <p className="text-slate-600 text-sm">Bank APIs, mobile money, POS, QR, USSD, wallets – all unified</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
            {nodes.map((node, index) => (
              <div key={index} className="group p-5 sm:p-6 bg-white rounded-2xl border border-slate-200/60 shadow-sm hover:border-[#F48B25]/50 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 flex items-center justify-between">
                <span className="text-sm font-bold text-[#1C1F61] group-hover:text-[#CF1B1B] transition-colors">
                  {node}
                </span>
                <span className="text-slate-300 group-hover:text-[#F48B25] text-xs font-mono font-bold transition-colors">
                  0{index + 1}
                </span>
              </div>
            ))}
      ...
      <section className="bg-white py-16 sm:py-20 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 space-y-2">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">Built for Scale & Security</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4 border-l-4 border-[#F48B25] pl-5">
              <span className="text-[10px] sm:text-xs font-bold text-[#CF1B1B] uppercase tracking-wider">Why Unify Payments?</span>
              ...
              <p className="text-slate-600 text-sm leading-relaxed">
                Replace fragmented payment integrations with a single, secure, and auditable settlement layer. Reduce operational costs, eliminate manual reconciliation, and increase collection efficiency.
              </p>
            </div>
      ...
      <section className="bg-white py-16 sm:py-20 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-3xl mx-auto mb-12 space-y-2">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">Trusted by Financial Ecosystems</h2>
          </div>
      ...
      {/* TECHNICAL HIGHLIGHTS – interoperability & security */}
      <section className="bg-[#1C1F61] text-white py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4">
              <span className="text-xs font-bold text-[#F48B25] uppercase tracking-wider">Interoperability Core</span>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight">One API, Every Channel</h2>
              <p className="text-slate-300 text-sm leading-relaxed">
                Our payment infrastructure abstracts the complexity of multiple acquirers, processors, and settlement rails. A single integration gives you access to all major payment methods in Africa – bank transfers, mobile money, cards, USSD, QR, and POS.
              </p>
              <ul className="space-y-2 pt-2">
                ...
                <li className="flex items-start gap-2 text-sm text-slate-300">
                  ...
                  Smart routing: automatic retry and fallback between acquirers
                </li>
                <li className="flex items-start gap-2 text-sm text-slate-300">
                  <svg className="w-4 h-4 text-[#F48B25] mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  Real‑time settlement reporting with full audit trail
                </li>
              </ul>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400">End‑to‑end encryption, tokenisation, and fraud scoring</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400">Handle thousands of transactions per second</p>
                  </div>
                </div>
              </div>
            </div>
