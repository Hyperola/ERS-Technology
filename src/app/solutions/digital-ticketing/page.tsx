...
export default function DigitalTicketingPage() {
  const deploymentVectors = [
    { 
      ...
      utilities: "Smart ticketing systems engineered to handle high-volume motor parks and transit corridors seamlessly. Real‑time validation, automated fare calculation, and instant reconciliation." 
    },
    { 
      venue: "Union Asset Validation", 
      utilities: "Real-time ticket tracking systems protecting drivers, transport unions, and local councils against ticket duplication, fare evasion, and revenue leakage." 
    },
    { 
      venue: "High-Throughput Commerce Arenas", 
      utilities: "Fast electronic ticketing applications built specifically to manage access and organize space levies inside dense public markets, event venues, and stadiums." 
    },
  ];
  ...
  const features = [
    {
      ...
      desc: "Continue ticket validation and issuance even without internet connectivity – data syncs automatically when network returns."
    },
    {
      title: "QR & NFC Verification",
      desc: "Support for QR codes, NFC tags, and biometric verification for multi‑layer security and fraud prevention."
    },
    {
      title: "Centralised Monitoring Dashboard",
      desc: "Real‑time view of all ticketing transactions, active gates, fare collection, and anomaly detection across every hub."
    },
    {
      title: "Automated Settlement & Reporting",
      desc: "Instant reconciliation between ticket sales, union accounts, and government treasuries – daily automated reports."
    },
    {
      title: "Dynamic Pricing Engine",
      desc: "Configure peak/off‑peak pricing, route‑based fares, and promotional discounts directly from the admin panel."
    },
    {
      title: "Passenger Analytics & Insights",
      desc: "Track commuter patterns, busy corridors, and revenue trends to optimise fleet deployment and pricing strategy."
    }
  ];

  const benefits = [
    "Eliminate ticket duplication and fake tickets",
    "Increase transit revenue by up to 40%",
    "Real‑time visibility across all collection points",
    "Automated reconciliation – no manual counting",
    "Seamless integration with existing transport apps"
  ];

  const servedSectors = [
    "Public Transport Authorities",
    "Transport Unions & Associations",
    "Motor Parks & Terminals",
    "Event & Stadium Management",
    "Public Markets & Trade Fairs",
  ...
  return (
    <main className="min-h-screen bg-[#F8FAFC] text-[#1C1F61] overflow-x-hidden selection:bg-[#F48B25]/30 selection:text-[#1C1F61] font-['Calibri',Calibri,Segoe_UI,sans-serif]">
      ...
      {/* HERO BANNER – reliable background image */}
      <section className="relative bg-[#1C1F61] text-white w-full overflow-hidden flex items-center min-h-[60vh] sm:min-h-0">
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="Bus transit and digital ticketing system"
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto px-6 md:px-12 py-12 sm:py-16 md:py-20 lg:py-24">
          <div className="max-w-3xl space-y-4 sm:space-y-5">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight leading-[1.2] text-white">
              ...
              <span className="text-[#F48B25]">Verification Platforms</span>
            </h1>
      ...
      {/* DEPLOYMENT VECTORS – 3 core use cases */}
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 space-y-2">
            <span className="text-[10px] sm:text-xs font-bold text-[#CF1B1B] uppercase tracking-wider">Core Deployments</span>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">Where ERS Ticketing Excels</h2>
            <p className="text-slate-600 text-sm">Trusted by transit authorities, unions, and venue operators</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            {deploymentVectors.map((vector, index) => (
              <div key={index} className="group p-6 sm:p-8 bg-white rounded-2xl border border-slate-200/60 shadow-sm hover:border-[#F48B25]/50 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-xl bg-gradient-to-br from-[#1C1F61] to-[#2a2e7a] text-white flex items-center justify-center font-bold text-xs sm:text-sm mb-5 group-hover:from-[#F48B25] group-hover:to-[#f59b3a] transition-all duration-300">
                  0{index + 1}
                </div>
      ...
      {/* FEATURES GRID – 6 technical capabilities */}
      <section className="bg-white py-16 sm:py-20 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 space-y-2">
            <span className="text-[10px] sm:text-xs font-bold text-[#CF1B1B] uppercase tracking-wider">Technical Capabilities</span>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">Built for Reliability & Scale</h2>
          </div>
      ...
      {/* KEY BENEFITS – from press release style */}
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4 border-l-4 border-[#F48B25] pl-5">
              <span className="text-[10px] sm:text-xs font-bold text-[#CF1B1B] uppercase tracking-wider">Why Digitise Ticketing?</span>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">Tangible Benefits for Transport Operators</h2>
              <p className="text-slate-600 text-sm leading-relaxed">
                Replace manual cash collections, paper tickets, and honour‑based systems with a fully auditable, tamper‑proof digital ecosystem.
              </p>
            </div>
      ...
      <section className="bg-white py-16 sm:py-20 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-3xl mx-auto mb-12 space-y-2">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">Trusted by Critical Mobility Sectors</h2>
          </div>
      ...
      {/* TECHNICAL HIGHLIGHTS – reliability & security */}
      <section className="bg-[#1C1F61] text-white py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4">
              <span className="text-xs font-bold text-[#F48B25] uppercase tracking-wider">Offline‑First Architecture</span>
              ...
              <p className="text-slate-300 text-sm leading-relaxed">
                Our ticketing systems are built for Africa's connectivity realities. Validators cache transactions locally and sync automatically when network returns – ensuring zero revenue loss during outages.
              </p>
              <ul className="space-y-2 pt-2">
                <li className="flex items-start gap-2 text-sm text-slate-300">
                  ...
                  Tamper‑proof hardware with encrypted storage
                </li>
                <li className="flex items-start gap-2 text-sm text-slate-300">
                  <svg className="w-4 h-4 text-[#F48B25] mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  Automatic reconciliation with central revenue dashboards
                </li>
                <li className="flex items-start gap-2 text-sm text-slate-300">
                  <svg className="w-4 h-4 text-[#F48B25] mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  Real‑time alerts for fraud or system anomalies
                </li>
              </ul>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400">Ticket data secured from issuance to validation</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-bold">High‑Throughput Processing</h4>
                    <p className="text-xs text-slate-400">Over 500 validations per second per gate</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto px-6 md:px-12">
          <div className="bg-gradient-to-br from-[#1C1F61] to-[#2a2e7a] text-white rounded-2xl sm:rounded-[2rem] p-6 sm:p-8 md:p-12 text-center space-y-5">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-extrabold tracking-tight max-w-2xl mx-auto leading-tight">
              Ready to Modernise Your Ticketing Infrastructure?
            </h2>
            <p className="text-slate-300 max-w-2xl text-xs sm:text-sm md:text-base leading-relaxed mx-auto">
              Join transport unions, local governments, and venue operators already using ERS to eliminate ticket fraud and maximise revenue.
            </p>
