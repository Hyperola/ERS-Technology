  ...
  return (
    <main className="min-h-screen bg-[#F8FAFC] text-[#0A2540] overflow-x-hidden selection:bg-[#E5981A]/30 selection:text-[#0A2540] font-['Calibri',Calibri,Segoe_UI,sans-serif]">
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24 py-20 relative z-20 -mt-10">
        <div className="bg-white border border-slate-200 rounded-2xl p-6 md:p-10 space-y-8 shadow-xl text-left">
          
          <div className="flex flex-wrap justify-between items-center gap-4 border-b border-slate-100 pb-6">
            <div>
              <span className="text-[10px] font-mono text-[#E5981A] uppercase block tracking-widest font-bold">
                Performance Dashboard Overview
              </span>
              <h3 className="text-xl font-bold text-[#0A2540] tracking-tight">
                Executive Revenue Insights
              </h3>
            </div>
            <div className="bg-[#F8FAFC] px-4 py-2 rounded-xl border border-slate-200/60 text-xs font-mono font-bold text-emerald-600 flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="bg-[#F8FAFC] p-6 rounded-xl border border-slate-200/60 space-y-2 group hover:border-[#E5981A]/40 transition-colors duration-300">
              <span className="text-[10px] font-mono font-bold text-slate-400 uppercase block">
                Aggregated Clearing Velocity
              </span>
              <div className="text-3xl font-bold text-[#0A2540]">99.98%</div>
            ...
            <div className="bg-[#F8FAFC] p-6 rounded-xl border border-slate-200/60 space-y-2 group hover:border-[#E5981A]/40 transition-colors duration-300">
              ...
              <div className="text-3xl font-bold text-[#E5981A]">0.02%</div>
              <p className="text-[11px] text-slate-500 font-normal">Instantly flagged to regional clearing units</p>
            </div>
            ...
            <div className="bg-[#F8FAFC] p-6 rounded-xl border border-slate-200/60 space-y-2 group hover:border-[#E5981A]/40 transition-colors duration-300">
              ...
              <div className="text-3xl font-bold text-[#0A2540]">+24.5%</div>
              <p className="text-[11px] text-slate-500 font-normal">Estimated matching trend next period</p>
            </div>
          </div>

          <p className="text-slate-600 text-sm font-normal leading-relaxed max-w-4xl border-t border-slate-100 pt-6">
