...
export default function FinancialAnalyticsPage() {
  const features = [
    {
      ...
      desc: "Live visualisation of collections, arrears, and disbursements across all revenue streams – updated every minute."
    },
    {
      title: "Predictive Analytics Engine",
      desc: "AI‑powered forecasts of future revenue inflows based on historical trends, seasonality, and economic indicators."
    },
    {
      title: "Anomaly & Fraud Detection",
      desc: "Automatically flag unusual transaction patterns, duplicate receipts, and potential revenue leakage with instant alerts."
    },
    {
      title: "Automated Regulatory Reporting",
      desc: "Generate GAAP/IFRS‑compliant reports for auditors, donor partners, and government oversight committees – one click."
    },
    {
      title: "Executive Mobile Dashboard",
      desc: "Access key metrics and alerts on the go via a secure, responsive mobile interface – no laptop required."
    },
    {
      title: "Custom KPI Builder",
      desc: "Create your own performance indicators, targets, and benchmarks – drag, drop, and visualise instantly."
    }
  ];

  const benefits = [
    "Make data‑driven decisions with real‑time intelligence",
    "Reduce revenue leakage by catching anomalies early",
    "Automate manual reporting – save hundreds of hours",
    "Predict future cash flows with up to 95% accuracy",
    "Enhance transparency for stakeholders and auditors"
  ];
  ...
  return (
    <main className="min-h-screen bg-[#F8FAFC] text-[#1C1F61] overflow-x-hidden selection:bg-[#F48B25]/30 selection:text-[#1C1F61] font-['Calibri',Calibri,Segoe_UI,sans-serif]">
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto px-6 md:px-12 py-12 sm:py-16 md:py-20 lg:py-24">
          <div className="max-w-3xl space-y-4 sm:space-y-5">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight leading-[1.2] text-white">
              ...
              <span className="text-[#F48B25]">Intelligence Frameworks</span>
            </h1>
      ...
      {/* METRICS PANEL – key performance indicators (restyled) */}
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-12 sm:py-16 relative z-20 -mt-6 sm:-mt-8">
        <div className="bg-white border border-slate-200 rounded-2xl p-6 md:p-10 space-y-8 shadow-xl">
          <div className="flex flex-wrap justify-between items-center gap-4 border-b border-slate-100 pb-6">
            <div>
              <span className="text-[10px] font-mono text-[#F48B25] uppercase block tracking-widest font-bold">
                Performance Dashboard Overview
              </span>
              <h3 className="text-xl font-bold text-[#1C1F61] tracking-tight">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="bg-[#F8FAFC] p-6 rounded-xl border border-slate-200/60 space-y-2 group hover:border-[#F48B25]/40 transition-all duration-300">
              <span className="text-[10px] font-mono font-bold text-slate-400 uppercase block">
                Aggregated Clearing Velocity
              </span>
              <div className="text-3xl font-bold text-[#1C1F61]">99.98%</div>
            ...
            <div className="bg-[#F8FAFC] p-6 rounded-xl border border-slate-200/60 space-y-2 group hover:border-[#F48B25]/40 transition-all duration-300">
              ...
              <div className="text-3xl font-bold text-[#F48B25]">0.02%</div>
              <p className="text-[11px] text-slate-500">Instantly flagged to regional clearing units</p>
            </div>
            ...
            <div className="bg-[#F8FAFC] p-6 rounded-xl border border-slate-200/60 space-y-2 group hover:border-[#F48B25]/40 transition-all duration-300">
              ...
              <div className="text-3xl font-bold text-[#1C1F61]">+24.5%</div>
              <p className="text-[11px] text-slate-500">Estimated matching trend next period</p>
            </div>
          </div>

          <p className="text-slate-600 text-sm leading-relaxed max-w-4xl border-t border-slate-100 pt-6">
      ...
      <section className="bg-white py-16 sm:py-20 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 space-y-2">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">Turn Data into Decisions</h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4 border-l-4 border-[#F48B25] pl-5">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">Tangible Benefits for Finance Leaders</h2>
              <p className="text-slate-600 text-sm leading-relaxed">
                Stop guessing and start knowing. Our analytics platform transforms raw transaction data into actionable intelligence – from real‑time dashboards to predictive forecasts.
              </p>
            </div>
      ...
      <section className="bg-white py-16 sm:py-20 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-3xl mx-auto mb-12 space-y-2">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">Trusted by Financial Administrators</h2>
          </div>
      ...
      {/* TECHNICAL HIGHLIGHTS – predictive & real‑time */}
      <section className="bg-[#1C1F61] text-white py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4">
              <span className="text-xs font-bold text-[#F48B25] uppercase tracking-wider">AI‑Powered Forecasting</span>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight">See the Future of Your Revenue</h2>
              <p className="text-slate-300 text-sm leading-relaxed">
                Our machine learning models analyse historical collection patterns, economic variables, and seasonal trends to predict future revenue with remarkable accuracy. Plan budgets, allocate resources, and set targets confidently.
              </p>
              <ul className="space-y-2 pt-2">
                <li className="flex items-start gap-2 text-sm text-slate-300">
                  ...
                  Automated anomaly alerts – catch fraud before it compounds
                </li>
                <li className="flex items-start gap-2 text-sm text-slate-300">
                  <svg className="w-4 h-4 text-[#F48B25] mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400">Role‑based access and data encryption at rest & in transit</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400">Live connection to collection systems and bank feeds</p>
                  </div>
                </div>
              </div>
            </div>
