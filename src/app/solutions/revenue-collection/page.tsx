...
export default function RevenueCollectionPage() {
  const features = [
    ...
    {
      title: "Digital Taxpayer Registration",
      desc: "Automated enumeration and digital identity profiling for individuals and businesses, expanding the tax net."
    },
    {
      title: "Automated Reconciliation & Audit Trails",
      desc: "Real‑time matching of collections to central accounts with immutable audit logs for complete transparency."
    }
  ];

  const benefits = [
    "Increase Internally Generated Revenue (IGR) by up to 35%",
    "Eliminate Revenue Leakages through cryptographic logging",
    "Digitize Revenue Collection Processes end‑to‑end",
    "Improve Compliance and Accountability with real‑time monitoring",
    "Automate Reporting and Reconciliation across all channels"
  ];
  ...
  return (
    <main className="min-h-screen bg-[#F8FAFC] text-[#1C1F61] overflow-x-hidden selection:bg-[#F48B25]/30 selection:text-[#1C1F61] font-['Calibri',Calibri,Segoe_UI,sans-serif]">
      ...
      {/* HERO BANNER – unique design with gradient overlay and CTA */}
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto px-6 md:px-12 py-12 sm:py-16 md:py-20 lg:py-24">
          <div className="max-w-3xl space-y-4 sm:space-y-5">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight leading-[1.2] text-white">
              ...
              <span className="text-[#F48B25]">Automation Systems</span>
            </h1>
      ...
      {/* FEATURE GRID – 6 cards, consistent with homepage card style */}
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 space-y-2">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">Intelligent Collection Engine</h2>
            <p className="text-slate-600 text-sm">End‑to‑end automation for taxes, levies, fees, and institutional collections</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
            {features.map((feat, idx) => (
              <div key={idx} className="group p-5 sm:p-6 bg-white rounded-2xl border border-slate-200/60 shadow-sm hover:border-[#F48B25]/50 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
      ...
      {/* KEY BENEFITS SECTION – from press release */}
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4 border-l-4 border-[#F48B25] pl-5">
              <span className="text-xs font-bold text-[#CF1B1B] uppercase tracking-wider">Why Automate?</span>
              ...
              <p className="text-slate-600 text-sm leading-relaxed">
                ERS Revenue Collection Systems replace fragmented manual processes with a unified, tamper‑proof digital framework. The results are immediate and measurable.
              </p>
            </div>
      ...
      {/* WHO WE SERVE – institutional alignment */}
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-3xl mx-auto mb-12 space-y-2">
            <span className="text-[10px] sm:text-xs font-bold text-[#CF1B1B] uppercase tracking-wider">Deployment Footprint</span>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">Trusted by Critical Sectors</h2>
            <p className="text-slate-600 text-sm">Our revenue collection systems are deployed across public and private institutions</p>
          </div>
      ...
      {/* TECHNICAL HIGHLIGHTS – similar to governance block */}
      <section className="bg-[#1C1F61] text-white py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4">
              <span className="text-xs font-bold text-[#F48B25] uppercase tracking-wider">Technical Excellence</span>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight">Secure, Scalable, Sovereign</h2>
              <p className="text-slate-300 text-sm leading-relaxed">
                Built on a cloud‑native architecture with end‑to‑end encryption, our revenue collection systems guarantee 99.9% uptime, real‑time reconciliation, and full auditability. The platform scales from a single local government to nationwide deployment.
              </p>
              <ul className="space-y-2 pt-2">
                ...
                <li className="flex items-start gap-2 text-sm text-slate-300">
                  ...
                  Real‑time integration with banking and mobile money networks
                </li>
                <li className="flex items-start gap-2 text-sm text-slate-300">
                  <svg className="w-4 h-4 text-[#F48B25] mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400">End‑to‑end encryption and PCI DSS compliance</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-bold">High‑Velocity Processing</h4>
                    <p className="text-xs text-slate-400">Thousands of transactions per second</p>
                  </div>
                </div>
              </div>
            </div>
