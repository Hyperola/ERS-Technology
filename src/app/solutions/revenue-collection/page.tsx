// src/app/solutions/revenue-collection/page.tsx
...
export default function RevenueCollectionPage() {
  const features = [
    { 
      ...
      desc: "Process payments flawlessly across bank branches, direct transfers, USSD, web gateways, and point-of-sale terminals." 
    },
    { 
      title: "Automated Assessment Engines", 
      desc: "Instantly compute precise direct and indirect statutory liabilities based on real-time municipal tax schedules." 
    },
    { 
      title: "Leakage Prevention Shield", 
      desc: "Eliminate cash handling vulnerabilities with end-to-end cryptographic transaction logging directly to state vaults." 
    },
    { 
      title: "Instant Notification Handlers", 
      desc: "Dispatch verifiable SMS and email receipts embedded with unique cryptographic tracking signatures to citizens instantly." 
    }
  ];
      ...
      <section className="relative bg-[#0A2540] text-white py-24 px-6 md:px-12 lg:px-24 flex flex-col justify-center min-h-[50vh] overflow-hidden">
        ...
        <div className="max-w-5xl space-y-6 relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl font-black tracking-tight leading-[1.1]">
            ...
            <span className="text-[#E5981A]">Automation Systems</span>
          </h1>
          <p className="text-slate-200 text-lg md:text-xl max-w-3xl leading-relaxed font-light">
            Engineered specifically to automate public sector administration, this high-velocity engine handles the end-to-end digitization of taxes, state levies, municipal fees, and unified institutional collections.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24 py-20 relative z-20 -mt-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {features.map((feat, idx) => (
            <div 
              key={idx} 
              className="group p-8 bg-white border border-slate-200 rounded-2xl shadow-xl hover:shadow-2xl hover:border-[#E5981A]/30 transition-all duration-300 transform hover:-translate-y-1 flex flex-col justify-between min-h-[240px]"
            >
      ...
      <section className="py-12 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto w-full">
        <div className="p-8 md:p-16 bg-[#0A2540] text-white rounded-3xl border border-white/10 shadow-2xl relative overflow-hidden group text-center space-y-6">
          ...
          <h3 className="text-3xl md:text-5xl font-black text-white tracking-tight max-w-3xl mx-auto leading-tight">
            Ready to Deploy Automated Architecture?
          </h3>
          <p className="text-slate-300 text-sm md:text-base leading-relaxed font-light max-w-2xl mx-auto">
            Our infrastructure unifies manual local governance tasks into clear digital records. It monitors every collection node continuously, giving regional administrative teams instantaneous visibility into daily fiscal targets.
          </p>
