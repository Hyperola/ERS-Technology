...
export default function CloudInfrastructurePage() {
  ...
  const features = [
    {
      title: "Multi‑Region Active‑Active Clusters",
      desc: "99.99% uptime SLA with automatic failover across geographically distributed data centres – no single point of failure."
    },
    {
      title: "Hardware Security Modules (HSM)",
      desc: "FIPS 140‑2 Level 3 certified HSMs for cryptographic key management and secure data processing."
    },
    {
      title: "Auto‑Scaling & Load Balancing",
      desc: "Elastic infrastructure that automatically scales up during peak collection periods and down during off‑hours – pay only for what you use."
    },
    {
      title: "Disaster Recovery & Backup",
      desc: "Automated daily backups with point‑in‑time recovery and cross‑region replication for business continuity."
    },
    {
      title: "Compliance‑Ready Architecture",
      desc: "Built to meet ISO 27001, NDPR, GDPR, and other regulatory standards out of the box."
    },
    {
      title: "Developer‑Friendly APIs",
      desc: "RESTful APIs with comprehensive documentation, sandbox environment, and real‑time monitoring dashboards."
    }
  ];

  const benefits = [
    "Zero‑downtime revenue collection – even during peak periods",
    "Data sovereignty – keep fiscal data within national borders",
    "Reduce infrastructure costs by up to 60% with elastic scaling",
    "Automated security patches and compliance updates",
    "Full audit trail of every system access and change"
  ];
  ...
  return (
    <main className="min-h-screen bg-[#F8FAFC] text-[#1C1F61] overflow-x-hidden selection:bg-[#F48B25]/30 selection:text-[#1C1F61] font-['Calibri',Calibri,Segoe_UI,sans-serif]">
      ...
      {/* HERO BANNER – brand colors, reliable cloud infrastructure image */}
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto px-6 md:px-12 py-12 sm:py-16 md:py-20 lg:py-24">
          <div className="max-w-3xl space-y-4 sm:space-y-5">
            ...
            <p className="text-slate-200 text-sm sm:text-base md:text-lg max-w-3xl leading-relaxed">
              Secure and scalable cloud-based deployment architecture built for Africa's revenue and mobility systems – with enterprise-grade resilience, compliance, and performance.
            </p>
      ...
      {/* CORE ARCHITECTURE PILLARS – original 3 + more detail */}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                  {architecturalPillars.map((pillar, idx) => (
                    <div key={idx} className="space-y-2 group">
                      <div className="h-1 w-8 bg-slate-200 group-hover:bg-[#CF1B1B] transition-colors mb-2" />
      ...
      <section className="bg-white py-16 sm:py-20 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 space-y-2">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">Built for Performance & Compliance</h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4 border-l-4 border-[#F48B25] pl-5">
              <span className="text-[10px] sm:text-xs font-bold text-[#CF1B1B] uppercase tracking-wider">Why Cloud‑Native?</span>
              ...
              <p className="text-slate-600 text-sm leading-relaxed">
                Move from on‑premise servers to a resilient, automatically scaling cloud infrastructure that eliminates downtime, reduces costs, and provides enterprise‑grade security out of the box.
              </p>
            </div>
      ...
      {/* TECHNICAL HIGHLIGHTS – security & resilience */}
      <section className="bg-[#1C1F61] text-white py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4">
              <span className="text-xs font-bold text-[#F48B25] uppercase tracking-wider">Enterprise‑Grade Security</span>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight">Data Sovereignty & Compliance</h2>
              <p className="text-slate-300 text-sm leading-relaxed">
                Your data stays within your jurisdiction. Our cloud infrastructure can be deployed on local data centres or major cloud providers (AWS, Azure, Google Cloud) – fully compliant with NDPR, GDPR, and ISO 27001.
              </p>
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 sm:p-8">
              <div className="space-y-4">
                <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                  ...
                  <div>
                    <h4 className="font-bold">Sovereign Cloud Ready</h4>
                    <p className="text-xs text-slate-400">Deploy on local infrastructure or major hyperscalers</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-bold">Elastic & Cost‑Efficient</h4>
                    <p className="text-xs text-slate-400">Pay only for the resources you actually use</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* FINAL CTA – consistent with homepage, secondary button links to homepage (no standalone technology page) */}
