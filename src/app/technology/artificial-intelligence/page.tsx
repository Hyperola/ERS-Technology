// src/app/technology/artificial-intelligence/page.tsx
import Link from 'next/link';

export default function ArtificialIntelligencePage() {
  const architecturalPillars = [
    {
      title: "Predictive Leakage Modeling",
      desc: "Deploys advanced machine learning pipelines to analyze historical transaction flows and immediately isolate high-risk behavior patterns before loss occurs."
    },
    {
      title: "Automated Data Annotation",
      desc: "Ingests structured and unstructured operator logs, applying neural processing layers to categorize and clean validation strings automatically."
    },
    {
      title: "Computer Vision Tracking",
      desc: "Integrates edge vision logic to process physical operational nodes, automatically crossing match metadata records against physical activity counters."
    }
  ];
      ...
      <section className="relative bg-[#0A2540] text-white py-24 px-6 md:px-12 lg:px-24 flex flex-col justify-center min-h-[50vh] overflow-hidden text-left">
        ...
        <div className="max-w-5xl space-y-6 relative z-10">
          <div className="inline-flex items-center gap-2 border border-[#E5981A]/30 bg-white/5 backdrop-blur-sm px-4 py-2 rounded-full text-xs font-bold tracking-widest text-[#E5981A] uppercase">
            <span className="w-2 h-1 bg-[#E5981A]" /> COGNITIVE DATA REDUCTION PROTOCOL
          </div>
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight leading-[1.1]">
            Artificial <br />
            <span className="text-[#E5981A]">Intelligence</span>
          </h1>
          <p className="text-slate-200 text-lg md:text-xl max-w-3xl leading-relaxed font-normal">
            AI-driven automation, analytics, and predictive intelligence.
          </p>
        </div>
      </section>
          ...
          <div className="lg:col-span-4 bg-white border border-slate-200 p-8 rounded-2xl flex flex-col justify-between relative overflow-hidden group hover:border-[#E5981A]/40 transition-all duration-300 shadow-xl min-h-[340px] text-left">
            <div className="space-y-4">
              ...
              <h3 className="text-xs font-mono font-bold text-[#E5981A] tracking-widest uppercase">
                Predictive Intelligence Controls
              </h3>
              <p className="text-slate-600 text-sm font-normal leading-relaxed">
                We embed autonomous evaluation engines directly into systemic data flows, replacing traditional retrospective auditing structures with instantaneous, forward-looking validation checkpoints.
              </p>
            </div>
            ...
            <div className="mt-8 border-t border-slate-100 pt-6">
              <Link href="/contact" className="text-xs font-mono font-bold uppercase text-[#0A2540] hover:text-[#A62626] tracking-wider flex items-center gap-1 transition-colors">
                Explore Predictive Intelligence <span className="group-hover:translate-x-1 transition-transform duration-200">&rarr;</span>
              </Link>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                {architecturalPillars.map((step, idx) => (
                  <div key={idx} className="space-y-2 group">
                    <div className="w-1.5 h-1.5 rounded-sm bg-slate-300 group-hover:bg-[#A62626] transition-colors mb-2" />
      ...
      <section className="py-12 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto w-full mb-12">
        <div className="p-8 md:p-16 bg-[#0A2540] text-white rounded-3xl border border-white/10 shadow-2xl relative overflow-hidden group text-center space-y-6">
          ...
          <h3 className="text-3xl md:text-5xl font-bold text-white tracking-tight max-w-3xl mx-auto leading-tight">
            Deploy Automated Verification Models
          </h3>
          <p className="text-slate-300 text-sm md:text-base leading-relaxed font-normal max-w-2xl mx-auto">
            Integrate intelligent exception detection, automated text sanitization parameters, and spatial transaction risk indices. Connect with our engineering group to customize your predictive pipelines.
          </p>
          <div className="pt-4 flex flex-col sm:flex-row gap-4 w-full justify-center max-w-md mx-auto">
            ...
            >
              Consult AI Infrastructure Team
            </Link>
          </div>
        </div>
      </section>
