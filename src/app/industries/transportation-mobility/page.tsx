// src/app/industries/transportation-mobility/page.tsx
import Link from 'next/link';

export default function TransportationMobilityPage() {
  const features = [
    {
      title: "Terminal Gate Automation",
      desc: "NFC card systems and quick QR code passes built to check in fleet schedules and register park terminal logistics swiftly."
    },
    {
      title: "Union Split Frameworks",
      desc: "Smart automated logic that takes incoming ticket revenue and instantly branches correct shares out to vehicle owners and unions."
    },
    {
      title: "Street‑Ready Terminal Software",
      desc: "Heavy‑duty, network‑resilient handheld terminal apps configured specifically to keep tracking records steady during fast roadside operations."
    },
    {
      title: "Real‑Time Fleet Monitoring",
      desc: "Live dashboard showing vehicle locations, passenger counts, and revenue per route – optimise deployment and reduce operating costs."
    },
    {
      title: "Offline‑First Ticket Validation",
      desc: "Validate tickets and record transactions even in network dead zones – data syncs automatically when connectivity returns."
    },
    {
      title: "Automated Compliance Reporting",
      desc: "Generate daily, weekly, or monthly reports for government transport authorities – fully auditable and tamper‑proof."
    }
  ];

  const benefits = [
    "Eliminate cash handling and ticket fraud",
    "Increase transit revenue by up to 40%",
    "Real‑time visibility into collections and fleet utilisation",
    "Automatic reconciliation – no manual counting",
    "Build commuter trust with transparent, verifiable records"
  ];

  const servedSectors = [
    "Public Bus & BRT Systems",
    "Minibus & Shared Taxi Associations",
    "Rail & Metro Authorities",
    "Ferry & Water Transport Operators",
    "Government Transport Regulators",
    "Park & Terminal Managers"
  ];
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto px-6 md:px-12 py-12 sm:py-16 md:py-20 lg:py-24">
          <div className="max-w-3xl space-y-4 sm:space-y-5">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight leading-[1.2] text-white">
              Transportation & <br />
              <span className="text-[#F48B25]">Mobility Revenue</span>
            </h1>
            <p className="text-slate-200 text-sm sm:text-base md:text-lg max-w-3xl leading-relaxed">
              Bringing automated collection infrastructure to busy transport hubs, fleet parks, tolls, and localized operator terminals – online or offline.
            </p>
            <div className="pt-2 flex flex-col sm:flex-row gap-3 sm:gap-4">
              <Link href="/contact" className="group relative bg-[#F48B25] hover:bg-[#f59b3a] text-[#1C1F61] font-bold text-xs sm:text-sm md:text-base px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl shadow-lg shadow-[#F48B25]/25 transition-all duration-300 text-center hover:-translate-y-0.5 active:translate-y-0 overflow-hidden w-full sm:w-auto">
                <span className="relative z-10 flex items-center justify-center gap-2">
                  Connect With Transport Engineers
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-12 sm:py-16 relative z-20 -mt-6 sm:-mt-8">
        <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 md:p-10 shadow-sm hover:shadow-xl transition-all duration-300 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-8 space-y-3">
            <span className="text-xs font-bold text-[#CF1B1B] uppercase tracking-widest">Optimised Fleet Logistics</span>
            <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-[#1C1F61]">Structured Transit Collections</h2>
            <p className="text-slate-600 text-sm md:text-base leading-relaxed">
              We optimise high‑frequency cash points for transit authorities and commercial operators. Our infrastructure tracks daily route volumes instantly, removing manual reconciliation burdens and securing the entire financial pathway from field agents back to core management systems.
            </p>
          </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 sm:p-8">
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-bold">Real‑Time Operator Dashboards</h4>
                    <p className="text-xs text-slate-400">Monitor fleet performance and revenue by route, vehicle, or driver</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto px-6 md:px-12">
          <div className="bg-gradient-to-br from-[#1C1F61] to-[#2a2e7a] text-white rounded-2xl sm:rounded-[2rem] p-6 sm:p-8 md:p-12 text-center space-y-5">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-extrabold tracking-tight max-w-2xl mx-auto leading-tight">
              Ready to Modernise Your Transport Revenue?
            </h2>
            <p className="text-slate-300 max-w-2xl text-xs sm:text-sm md:text-base leading-relaxed mx-auto">
              Join transport unions, local governments, and fleet owners already using ERS to eliminate ticket fraud, automate reconciliation, and maximise revenue.
            </p>
