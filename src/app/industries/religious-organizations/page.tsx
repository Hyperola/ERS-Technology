// src/app/industries/religious-organizations/page.tsx
import Link from 'next/link';

export default function ReligiousOrganizationsPage() {
  const features = [
    {
      title: "Multi‑Channel Giving",
      desc: "Accept regular assembly contributions securely through accessible mobile text pathways, fast in‑person kiosks, and online web platforms."
    },
    {
      title: "Project Pledge Trackers",
      desc: "Give construction project heads and advisory committees absolute oversight over long‑term financial promises and capital milestones."
    },
    {
      title: "Automated Private Receipts",
      desc: "Send discrete transaction summaries directly to community supporters immediately through secure, end‑to‑end messaging channels."
    },
    {
      title: "Recurring Donation Management",
      desc: "Allow members to set up weekly, monthly, or quarterly automated contributions – with easy pause or cancellation options."
    },
    {
      title: "Event & Camp Registration",
      desc: "Collect fees for conferences, retreats, and outreach programs – with attendee tracking and automated confirmations."
    },
    {
      title: "Financial Transparency Dashboard",
      desc: "Provide leadership and members with clear, real‑time views of income, expenditure, and project progress – build trust through openness."
    }
  ];

  const benefits = [
    "Increase giving by up to 40% with convenient digital channels",
    "Reduce administrative overhead – automate receipting and reconciliation",
    "Build member trust with transparent, verifiable financial records",
    "Enable remote giving – members can contribute from anywhere",
    "Simplify project fundraising with dedicated pledge trackers"
  ];
  ...
  return (
    <main className="min-h-screen bg-[#F8FAFC] text-[#1C1F61] overflow-x-hidden selection:bg-[#F48B25]/30 selection:text-[#1C1F61] font-['Calibri',Calibri,Segoe_UI,sans-serif]">
      ...
      {/* HERO BANNER – brand colors, unique religious image */}
      <section className="relative bg-[#1C1F61] text-white w-full overflow-hidden flex items-center min-h-[60vh] sm:min-h-0">
        <div className="absolute inset-0 z-0">
          <img 
            src="https://images.unsplash.com/photo-1438232992991-995b7058bbb3?q=80&w=2070"
            alt="Religious organization and donation"
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto px-6 md:px-12 py-12 sm:py-16 md:py-20 lg:py-24">
          <div className="max-w-3xl space-y-4 sm:space-y-5">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight leading-[1.2] text-white">
              ...
              <span className="text-[#F48B25]">Donation Infrastructure</span>
            </h1>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-12 sm:py-16 relative z-20 -mt-6 sm:-mt-8">
        <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 md:p-10 shadow-sm hover:shadow-xl transition-all duration-300 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-8 space-y-3">
            <span className="text-xs font-bold text-[#CF1B1B] uppercase tracking-widest">Discrete and Secure Frameworks</span>
            <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-[#1C1F61]">Transparent Assembly Ledgers</h2>
            <p className="text-slate-600 text-sm md:text-base leading-relaxed">
              We make it easy for members to connect with community development projects and regular assembly giving safely from anywhere. Our tools organise incoming resources automatically, minimising manual bookkeeping loads after large gatherings.
            </p>
          </div>
      ...
      <section className="bg-white py-16 sm:py-20 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 space-y-2">
            <span className="text-[10px] sm:text-xs font-bold text-[#CF1B1B] uppercase tracking-wider">Donation Capabilities</span>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">What Our Giving Platform Delivers</h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4 border-l-4 border-[#F48B25] pl-5">
              <span className="text-[10px] sm:text-xs font-bold text-[#CF1B1B] uppercase tracking-wider">Why Digitise Giving?</span>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">Tangible Benefits for Faith Organisations</h2>
              <p className="text-slate-600 text-sm leading-relaxed">
                Replace cash envelopes and manual spreadsheets with a fully auditable, secure digital giving system. Increase contributions, reduce administrative burden, and build member trust through transparency.
              </p>
            </div>
      ...
      <section className="bg-white py-16 sm:py-20 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-3xl mx-auto mb-12 space-y-2">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">Trusted by Faith‑Based Organisations</h2>
          </div>
      ...
      {/* TECHNICAL HIGHLIGHTS – security & transparency */}
      <section className="bg-[#1C1F61] text-white py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4">
              <span className="text-xs font-bold text-[#F48B25] uppercase tracking-wider">Private & Secure by Default</span>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight">Respect Donor Privacy, Maintain Auditability</h2>
              <p className="text-slate-300 text-sm leading-relaxed">
                Our giving platform respects donor anonymity while providing leadership with aggregated financial reports. All transactions are encrypted, receipts are sent privately, and data is stored in compliance with local privacy laws.
              </p>
              <ul className="space-y-2 pt-2">
                <li className="flex items-start gap-2 text-sm text-slate-300">
                  ...
                  Anonymous giving option – donor identity hidden from public view
                </li>
                <li className="flex items-start gap-2 text-sm text-slate-300">
                  <svg className="w-4 h-4 text-[#F48B25] mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  Automated tax‑deductible receipts (where applicable)
                </li>
                <li className="flex items-start gap-2 text-sm text-slate-300">
                  <svg className="w-4 h-4 text-[#F48B25] mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  Role‑based access – treasurers see details, members see only their own
                </li>
              </ul>
            </div>
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 sm:p-8">
              <div className="space-y-4">
                <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                  ...
                  <div>
                    <h4 className="font-bold">Multiple Giving Channels</h4>
                    <p className="text-xs text-slate-400">Card, bank transfer, USSD, mobile money, cash, and cheque</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-bold">Real‑Time Reporting for Leaders</h4>
                    <p className="text-xs text-slate-400">Dashboard with giving trends, project progress, and budget tracking</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto px-6 md:px-12">
          <div className="bg-gradient-to-br from-[#1C1F61] to-[#2a2e7a] text-white rounded-2xl sm:rounded-[2rem] p-6 sm:p-8 md:p-12 text-center space-y-5">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-extrabold tracking-tight max-w-2xl mx-auto leading-tight">
              Ready to Modernise Your Giving Infrastructure?
            </h2>
            <p className="text-slate-300 max-w-2xl text-xs sm:text-sm md:text-base leading-relaxed mx-auto">
              Join faith organisations already using ERS to increase giving, automate receipts, and build donor trust through transparency.
            </p>
