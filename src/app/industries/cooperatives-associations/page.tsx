// src/app/industries/cooperatives-associations/page.tsx
import Link from 'next/link';

export default function CooperativesAssociationsPage() {
  const features = [
    {
      title: "Automated Contribution Tracking",
      desc: "Members can execute structured savings deposits safely from their primary bank profiles or localized e‑wallets."
    },
    {
      title: "Proportional Split Engines",
      desc: "Smart internal accounting logic built to calculate dividend fractions accurately based instantly on member equity balances."
    },
    {
      title: "Credit Management Tools",
      desc: "Digital request profiles and credit review dashboards structured to run internal group borrowing programs securely."
    },
    {
      title: "Member Self‑Service Portal",
      desc: "Members view their contributions, loan balances, dividend history, and download statements – 24/7 from any device."
    },
    {
      title: "Automated Loan Disbursement & Repayment",
      desc: "Process loan approvals, disburse funds directly to member accounts, and track repayments with automated reminders."
    },
    {
      title: "Executive Dashboard & Reporting",
      desc: "Real‑time view of total savings, outstanding loans, dividend pools, and member activity – with exportable reports."
    }
  ];

  const benefits = [
    "Increase member participation with transparent, digital records",
    "Eliminate manual logbooks and reconciliation errors",
    "Reduce loan default rates with automated repayment tracking",
    "Automate dividend calculations – fair, accurate, instant",
    "Build member trust through 24/7 access to their financial data"
  ];
  ...
  return (
    <main className="min-h-screen bg-[#F8FAFC] text-[#1C1F61] overflow-x-hidden selection:bg-[#F48B25]/30 selection:text-[#1C1F61] font-['Calibri',Calibri,Segoe_UI,sans-serif]">
      ...
      {/* HERO BANNER – brand colors, unique cooperative image */}
      <section className="relative bg-[#1C1F61] text-white w-full overflow-hidden flex items-center min-h-[60vh] sm:min-h-0">
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="Cooperatives and associations"
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-12 sm:py-16 relative z-20 -mt-6 sm:-mt-8">
        <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 md:p-10 shadow-sm hover:shadow-xl transition-all duration-300 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-8 space-y-3">
            <span className="text-xs font-bold text-[#CF1B1B] uppercase tracking-widest">Communal Wealth Automation</span>
            <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-[#1C1F61]">Protected Financial Aggregation</h2>
            <p className="text-slate-600 text-sm md:text-base leading-relaxed">
              We replace error‑prone manual logbooks with secure, automated financial records. Our systems allow members to run periodic contributions directly, giving administrators real‑time tracking metrics over capital growth pools.
            </p>
          </div>
      ...
      <section className="bg-white py-16 sm:py-20 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 space-y-2">
            <span className="text-[10px] sm:text-xs font-bold text-[#CF1B1B] uppercase tracking-wider">Cooperative Capabilities</span>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">What Our Cooperative Platform Delivers</h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4 border-l-4 border-[#F48B25] pl-5">
              <span className="text-[10px] sm:text-xs font-bold text-[#CF1B1B] uppercase tracking-wider">Why Automate Cooperative Finance?</span>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">Tangible Benefits for Member‑Owned Organisations</h2>
              <p className="text-slate-600 text-sm leading-relaxed">
                Replace paper logbooks, manual calculations, and delayed reporting with a fully auditable, transparent digital platform. Increase member trust, reduce administrative costs, and scale your cooperative's impact.
              </p>
            </div>
      ...
      {/* WHO WE SERVE – cooperative sectors */}
      <section className="bg-white py-16 sm:py-20 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-3xl mx-auto mb-12 space-y-2">
            <span className="text-[10px] sm:text-xs font-bold text-[#CF1B1B] uppercase tracking-wider">Deployment Footprint</span>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">Trusted by Member‑Owned Organisations</h2>
          </div>
      ...
      {/* TECHNICAL HIGHLIGHTS – member transparency & automation */}
      <section className="bg-[#1C1F61] text-white py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4">
              <span className="text-xs font-bold text-[#F48B25] uppercase tracking-wider">Member‑First Design</span>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight">Every Member Sees Their Own Data</h2>
              <p className="text-slate-300 text-sm leading-relaxed">
                Our platform gives each member secure, private access to their contribution history, loan balance, dividend accruals, and transaction statements. Admins get a consolidated view of the entire cooperative – with role‑based controls.
              </p>
              <ul className="space-y-2 pt-2">
                <li className="flex items-start gap-2 text-sm text-slate-300">
                  ...
                  Automated share capital and savings tracking
                </li>
                <li className="flex items-start gap-2 text-sm text-slate-300">
                  <svg className="w-4 h-4 text-[#F48B25] mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  Loan application & approval workflow with automated credit scoring
                </li>
                <li className="flex items-start gap-2 text-sm text-slate-300">
                  <svg className="w-4 h-4 text-[#F48B25] mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  Annual general meeting (AGM) reporting packs – one click
                </li>
              </ul>
            </div>
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 sm:p-8">
              <div className="space-y-4">
                <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                  ...
                  <div>
                    <h4 className="font-bold">Multiple Contribution Channels</h4>
                    <p className="text-xs text-slate-400">Bank transfer, mobile money, cash collections, payroll deduction</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-bold">Audit‑Ready Financials</h4>
                    <p className="text-xs text-slate-400">Full trial balance, member statements, and regulatory reports</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto px-6 md:px-12">
          <div className="bg-gradient-to-br from-[#1C1F61] to-[#2a2e7a] text-white rounded-2xl sm:rounded-[2rem] p-6 sm:p-8 md:p-12 text-center space-y-5">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-extrabold tracking-tight max-w-2xl mx-auto leading-tight">
              Ready to Modernise Your Cooperative's Finances?
            </h2>
            <p className="text-slate-300 max-w-2xl text-xs sm:text-sm md:text-base leading-relaxed mx-auto">
              Join SACCOs, trade unions, and community savings groups already using ERS to automate contributions, track loans, and build member trust through transparency.
            </p>
