// src/app/industries/smes-enterprises/page.tsx
import Link from 'next/link';

export default function SmesEnterprisesPage() {
  const features = [
    {
      title: "Wholesale Bulk Invoicing",
      desc: "Instantly deploy hundreds of branded, custom invoice paths out to major distribution networks at the exact same time."
    },
    {
      title: "Unified Acceptance Rails",
      desc: "Process local credit cards, digital bank codes, and mobile money networks inside one clean, integrated dashboard."
    },
    {
      title: "Staff Access Controls",
      desc: "Protect sensitive daily capital logs by strictly isolating floor cashier view rights from executive audit folders."
    },
    {
      title: "Multi‑Store Consolidation",
      desc: "Aggregate sales, inventory, and customer data from multiple branches or franchises into a single back‑office dashboard."
    },
    {
      title: "Automated Reconciliation",
      desc: "Match sales from POS, e‑commerce, and mobile money channels to bank deposits – no manual entry."
    },
    {
      title: "Supplier & Inventory Management",
      desc: "Track purchase orders, supplier payments, and stock levels – with automated reorder alerts and payment scheduling."
    }
  ];

  const benefits = [
    "Reduce payment reconciliation time by up to 80%",
    "Eliminate cash handling risks and fraud",
    "Real‑time visibility across all sales channels and locations",
    "Automate supplier payments and bulk invoice distribution",
    "Scale from single store to hundreds of outlets seamlessly"
  ];
  ...
  const servedSectors = [
    ...
    "Franchise Networks",
    "Service Enterprises (salons, clinics, workshops)"
  ];
  ...
  return (
    <main className="min-h-screen bg-[#F8FAFC] text-[#1C1F61] overflow-x-hidden selection:bg-[#F48B25]/30 selection:text-[#1C1F61] font-['Calibri',Calibri,Segoe_UI,sans-serif]">
      ...
      {/* HERO BANNER – brand colors, unique SME/retail image */}
      <section className="relative bg-[#1C1F61] text-white w-full overflow-hidden flex items-center min-h-[60vh] sm:min-h-0">
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="SME and enterprise payments"
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-12 sm:py-16 relative z-20 -mt-6 sm:-mt-8">
        <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 md:p-10 shadow-sm hover:shadow-xl transition-all duration-300 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-8 space-y-3">
            <span className="text-xs font-bold text-[#CF1B1B] uppercase tracking-widest">Unified Retail Engines</span>
            <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-[#1C1F61]">Corporate Cash Management</h2>
            <p className="text-slate-600 text-sm md:text-base leading-relaxed">
              We remove the vulnerabilities of loose supplier chains and separate payment systems. Our tools sync front‑end cashiers directly with central accounting registries, keeping enterprise cash management automated, protected, and balanced.
            </p>
          </div>
      ...
      <section className="bg-white py-16 sm:py-20 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 space-y-2">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">What Our Business Platform Delivers</h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4 border-l-4 border-[#F48B25] pl-5">
              <span className="text-[10px] sm:text-xs font-bold text-[#CF1B1B] uppercase tracking-wider">Why Digitise Business Payments?</span>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">Tangible Benefits for SMEs and Enterprises</h2>
              <p className="text-slate-600 text-sm leading-relaxed">
                Replace fragmented payment systems, manual reconciliation, and cash handling with a unified, auditable digital platform. Reduce costs, improve cash flow, and scale effortlessly.
              </p>
            </div>
      ...
      {/* WHO WE SERVE – business sectors */}
      <section className="bg-white py-16 sm:py-20 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-3xl mx-auto mb-12 space-y-2">
            <span className="text-[10px] sm:text-xs font-bold text-[#CF1B1B] uppercase tracking-wider">Deployment Footprint</span>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">Trusted by Growing Businesses</h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4">
              <span className="text-xs font-bold text-[#F48B25] uppercase tracking-wider">Built for Scale</span>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight">From One Store to Hundreds – Seamlessly</h2>
              <p className="text-slate-300 text-sm leading-relaxed">
                Our platform grows with your business. Start with a single location, add multi‑store support, franchise management, and wholesale invoicing as you expand – no platform migration, no data silos.
              </p>
              <ul className="space-y-2 pt-2">
                <li className="flex items-start gap-2 text-sm text-slate-300">
                  ...
                  Centralised dashboard for multi‑store performance
                </li>
                <li className="flex items-start gap-2 text-sm text-slate-300">
                  <svg className="w-4 h-4 text-[#F48B25] mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  Role‑based access for cashiers, managers, and executives
                </li>
                <li className="flex items-start gap-2 text-sm text-slate-300">
                  <svg className="w-4 h-4 text-[#F48B25] mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  Automated supplier payments and bulk invoice distribution
                </li>
              </ul>
            </div>
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 sm:p-8">
              <div className="space-y-4">
                <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                  ...
                  <div>
                    <h4 className="font-bold">Integrated Payment Channels</h4>
                    <p className="text-xs text-slate-400">POS, e‑commerce, mobile money, bank transfers – all in one dashboard</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-bold">Real‑Time Financial Reporting</h4>
                    <p className="text-xs text-slate-400">Profit & loss, cash flow, and sales by location – always up to date</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto px-6 md:px-12">
          <div className="bg-gradient-to-br from-[#1C1F61] to-[#2a2e7a] text-white rounded-2xl sm:rounded-[2rem] p-6 sm:p-8 md:p-12 text-center space-y-5">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-extrabold tracking-tight max-w-2xl mx-auto leading-tight">
              Ready to Modernise Your Business Payments?
            </h2>
            <p className="text-slate-300 max-w-2xl text-xs sm:text-sm md:text-base leading-relaxed mx-auto">
              Join SMEs and enterprises already using ERS to unify payment channels, automate reconciliation, and scale operations.
            </p>
