// src/app/industries/education-institutions/page.tsx
  ...
  const features = [
    {
      ...
      desc: "Every inbound payment maps automatically to an active student registration card, completely eliminating manual bank record searches."
    },
    {
      title: "Installment Timelines",
      desc: "Structured billing periods driven by automatic text and email alert milestones to keep family accounts updated transparently."
    },
    {
      title: "Campus Shop Unification",
      desc: "Centralized accounting ledger that easily loops auxiliary points like book depots, uniform bays, and activity fees into one screen."
    },
    {
      title: "Parent Self‑Service Portal",
      desc: "Parents can view fee schedules, make payments, download receipts, and track their child's balance – 24/7, from any device."
    },
    {
      title: "Automated Arrears Management",
      desc: "Generate automatic reminders, late fee penalties, and restriction notices for overdue accounts – fully configurable."
    },
    {
      title: "Real‑Time Bursar Dashboard",
      desc: "Live view of collections by class, term, or fee type – with performance reports and bank reconciliation tools."
    }
  ];

  const benefits = [
    "Reduce fee collection time by up to 70%",
    "Eliminate manual bank reconciliation – match payments automatically",
    "Improve parent satisfaction with transparent, real‑time fee portals",
    "Increase on‑time payments with automated reminders",
    "Centralise all campus revenue – tuition, shops, events, and donations"
  ];
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto px-6 md:px-12 py-12 sm:py-16 md:py-20 lg:py-24">
          <div className="max-w-3xl space-y-4 sm:space-y-5">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight leading-[1.2] text-white">
              ...
              <span className="text-[#F48B25]">School Fee Automation</span>
            </h1>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-12 sm:py-16 relative z-20 -mt-6 sm:-mt-8">
        <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 md:p-10 shadow-sm hover:shadow-xl transition-all duration-300 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-8 space-y-3">
            <span className="text-xs font-bold text-[#CF1B1B] uppercase tracking-widest">Predictable Academic Cash Flow</span>
            <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-[#1C1F61]">Unified School Billing Architecture</h2>
            <p className="text-slate-600 text-sm md:text-base leading-relaxed">
              We remove the administrative burden of manually chasing term arrears and auditing bank logs. Our campus frameworks synchronise student IDs directly with arriving payments, giving bursars clear, automatic bookkeeping records.
            </p>
          </div>
      ...
      <section className="bg-white py-16 sm:py-20 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 space-y-2">
            <span className="text-[10px] sm:text-xs font-bold text-[#CF1B1B] uppercase tracking-wider">Education Capabilities</span>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">What Our School Fee Platform Delivers</h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4 border-l-4 border-[#F48B25] pl-5">
              <span className="text-[10px] sm:text-xs font-bold text-[#CF1B1B] uppercase tracking-wider">Why Automate School Fees?</span>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">Tangible Benefits for Educational Institutions</h2>
              <p className="text-slate-600 text-sm leading-relaxed">
                Replace manual cash collections, paper receipts, and spreadsheet tracking with a fully auditable, tamper‑proof digital system. Reduce arrears, improve cash flow, and free up administrative staff for core educational duties.
              </p>
            </div>
      ...
      <section className="bg-white py-16 sm:py-20 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-3xl mx-auto mb-12 space-y-2">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#1C1F61]">Trusted by Educational Institutions</h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4">
              <span className="text-xs font-bold text-[#F48B25] uppercase tracking-wider">Smart Student Matching</span>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight">Every Payment, Instantly Identified</h2>
              <p className="text-slate-300 text-sm leading-relaxed">
                Our platform uses unique payment references linked to each student's registration number. When a parent pays, the system instantly matches the transaction to the correct student – no manual reconciliation, no misallocated funds.
              </p>
              <ul className="space-y-2 pt-2">
                <li className="flex items-start gap-2 text-sm text-slate-300">
                  ...
                  Bulk payment upload for multiple students (family discounts)
                </li>
                <li className="flex items-start gap-2 text-sm text-slate-300">
                  <svg className="w-4 h-4 text-[#F48B25] mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  Automated generation of official school receipts with QR verification
                </li>
                <li className="flex items-start gap-2 text-sm text-slate-300">
                  <svg className="w-4 h-4 text-[#F48B25] mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  Real‑time integration with school ERP and accounting systems
                </li>
              </ul>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400">Bank transfer, card, USSD, mobile money, cash at designated banks</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-bold">Parent Self‑Service</h4>
                    <p className="text-xs text-slate-400">View fee history, print receipts, and download tax certificates</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto px-6 md:px-12">
          <div className="bg-gradient-to-br from-[#1C1F61] to-[#2a2e7a] text-white rounded-2xl sm:rounded-[2rem] p-6 sm:p-8 md:p-12 text-center space-y-5">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-extrabold tracking-tight max-w-2xl mx-auto leading-tight">
              Ready to Modernise Your School Fee Collections?
            </h2>
            <p className="text-slate-300 max-w-2xl text-xs sm:text-sm md:text-base leading-relaxed mx-auto">
              Join schools, universities, and training centres already using ERS to eliminate cash leakages, automate reconciliation, and improve parent satisfaction.
            </p>
