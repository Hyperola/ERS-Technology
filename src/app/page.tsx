    ...
    <div className="flex flex-col min-h-screen overflow-x-hidden bg-[#F8FAFC] text-[#0A2540] selection:bg-[#E5981A]/30 selection:text-[#0A2540] font-['Calibri',Calibri,Segoe_UI,sans-serif] antialiased">
      ...
      <section className="relative bg-[#0A2540] text-white w-full overflow-hidden flex items-center px-5 sm:px-6 md:px-12 lg:px-24 pt-6 sm:pt-8 md:pt-12 lg:pt-16 pb-12 sm:pb-20 md:pb-28 lg:pb-32">
        ...
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-[#0A2540]/90 via-[#0A2540]/80 to-[#0A2540]/90 sm:bg-gradient-to-r sm:from-[#0A2540] sm:via-[#0A2540]/80 sm:to-transparent" />
        ...
        <div className="relative z-20 w-full max-w-6xl mx-auto">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold tracking-tight leading-[1.2] sm:leading-[1.15] text-white mb-3 sm:mb-4 animate-in fade-in slide-in-from-bottom-6 duration-700 delay-100">
            ...
            <span className="text-[#E5981A] relative inline-block">
              Digital Revenue
              <svg className="absolute -bottom-1 left-0 w-full h-1.5 sm:h-2 text-[#E5981A]/40" viewBox="0 0 400 12" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <section className="bg-[#F8FAFC] py-12 sm:py-20 px-5 sm:px-6 md:px-12 lg:px-24 border-b border-slate-200/80 relative z-30 -mt-6 sm:-mt-10 rounded-t-2xl sm:rounded-t-[2.5rem] shadow-[0_-15px_40px_-15px_rgba(0,0,0,0.25)]">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8 sm:mb-12 border-l-4 border-[#0A2540] pl-4 sm:pl-5 animate-in fade-in slide-in-from-bottom-6 duration-700">
            <h2 className="text-[10px] sm:text-xs font-bold uppercase tracking-widest text-[#A62626] mb-1">Gateways</h2>
            <p className="text-xl sm:text-2xl md:text-3xl font-extrabold tracking-tight text-[#0A2540]">Quick Access Portals</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {portals.map((portal, index) => (
              <div 
                key={index} 
                className="group p-5 sm:p-6 bg-white rounded-2xl border border-slate-200/80 hover:border-[#E5981A] transition-all duration-500 flex flex-col justify-between shadow-sm hover:shadow-xl hover:-translate-y-2 cursor-pointer animate-in fade-in slide-in-from-bottom-8"
                style={{ animationDelay: `${index * 100}ms`, animationFillMode: 'both' }}
              >
                <div>
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-[#E5981A]/10 flex items-center justify-center mb-3 sm:mb-4 group-hover:bg-[#E5981A] transition-all duration-300 group-hover:shadow-lg">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6 text-[#E5981A] group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                    </svg>
                  </div>
                  <h3 className="font-bold text-[#0A2540] group-hover:text-[#A62626] text-base sm:text-lg mb-2 transition-colors duration-300">
                    {portal.name}
                  </h3>
                ...
                <div className="mt-6 sm:mt-8 text-[10px] sm:text-xs font-bold tracking-wider text-[#0A2540] group-hover:text-[#E5981A] flex items-center gap-1 transition-all duration-300 pt-3 sm:pt-4 border-t border-slate-100">
                  Access Portal 
                  <svg className="w-2.5 h-2.5 sm:w-3 sm:h-3 group-hover:translate-x-1.5 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                  </svg>
                </div>
              </div>
      ...
      <section className="py-16 sm:py-24 px-5 sm:px-6 md:px-12 lg:px-24 max-w-7xl mx-auto w-full relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 items-start">
          <div className="lg:col-span-1 space-y-4 lg:sticky lg:top-8 border-l-4 border-[#E5981A] pl-5 animate-in fade-in slide-in-from-bottom-6 duration-700">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#0A2540] leading-tight">Flagship Infrastructure Services</h2>
          ...
          <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
            {coreSolutions.map((item, index) => (
              <div 
                key={index} 
                className="group p-5 sm:p-6 bg-white rounded-2xl border border-slate-200/60 shadow-sm hover:border-[#E5981A]/60 hover:shadow-xl transition-all duration-500 hover:-translate-y-1 animate-in fade-in slide-in-from-bottom-8"
                style={{ animationDelay: `${index * 100}ms`, animationFillMode: 'both' }}
              >
                <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-xl bg-gradient-to-br from-[#0A2540] to-[#1a3a5c] text-white flex items-center justify-center font-bold text-xs sm:text-sm mb-4 sm:mb-5 group-hover:from-[#E5981A] group-hover:to-[#f5a92a] transition-all duration-300 shadow-md">
                  0{index + 1}
                </div>
                <h3 className="text-base sm:text-lg font-bold text-[#0A2540] mb-2 group-hover:text-[#A62626] transition-colors duration-300">{item.title}</h3>
      ...
      <section className="bg-[#0A2540] text-white py-16 sm:py-24 px-5 sm:px-6 md:px-12 lg:px-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 space-y-3 animate-in fade-in slide-in-from-bottom-6 duration-700">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6">
            {[
              ...
              <div 
                key={i} 
                className="group p-6 sm:p-8 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 text-center hover:bg-white/[0.08] transition-all duration-500 hover:scale-105 hover:border-white/20 animate-in fade-in slide-in-from-bottom-8"
                style={{ animationDelay: `${i * 150}ms`, animationFillMode: 'both' }}
              >
                <div className="text-3xl sm:text-4xl md:text-5xl font-black text-[#E5981A] tracking-tight mb-2 group-hover:scale-110 transition-transform duration-300 inline-block">
                  {stat.val}
                </div>
      ...
      <section className="py-16 sm:py-24 px-5 sm:px-6 md:px-12 lg:px-24 bg-white border-t border-slate-100">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 lg:gap-12">
            <div className="max-w-xl space-y-4 border-l-4 border-[#A62626] pl-5 animate-in fade-in slide-in-from-bottom-6 duration-700">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-[#0A2540] leading-tight">Engineered for Critical Sectors</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 flex-1 w-full">
              {[
                ...
                <div 
                  key={idx} 
                  className="group p-4 sm:p-5 bg-[#F8FAFC] rounded-xl border border-slate-200/70 hover:border-[#0A2540] hover:bg-white hover:shadow-lg transition-all duration-400 hover:-translate-y-1 cursor-pointer animate-in fade-in slide-in-from-bottom-8"
                  style={{ animationDelay: `${idx * 100}ms`, animationFillMode: 'both' }}
                >
                  <div className="flex items-start gap-3">
                    <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-[#E5981A]/10 group-hover:bg-[#E5981A] transition-colors duration-300 flex items-center justify-center">
                      <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#E5981A] group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                      </svg>
                    </div>
                    <div>
                      <h4 className="font-bold text-[#0A2540] text-sm sm:text-base mb-1.5 group-hover:text-[#A62626] transition-colors">{sector.title}</h4>
                      <p className="text-slate-600 text-[11px] sm:text-xs leading-relaxed font-normal">{sector.label}</p>
                    </div>
                  </div>
                </div>
              ))}
      ...
      <section className="py-16 sm:py-20 px-5 sm:px-6 md:px-12 lg:px-24 bg-[#F8FAFC] relative overflow-hidden border-t border-slate-200/60">
        <div className="max-w-5xl mx-auto bg-gradient-to-br from-[#0A2540] to-[#143450] text-white rounded-2xl sm:rounded-[2rem] p-6 sm:p-8 md:p-16 relative overflow-hidden border border-white/10 shadow-2xl flex flex-col items-center text-center space-y-5 sm:space-y-6 animate-in fade-in zoom-in-95 duration-700">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200px] sm:w-[300px] h-[200px] sm:h-[300px] bg-[#E5981A]/5 rounded-full blur-3xl" />
          
          <div className="inline-flex animate-bounce-in">
            <span className="text-[10px] sm:text-xs text-[#E5981A] tracking-widest uppercase border border-[#E5981A]/40 px-3 sm:px-4 py-1 sm:py-1.5 rounded-full bg-[#E5981A]/10 font-bold backdrop-blur-sm">
              Deployment Gateway
            </span>
          </div>
          
          <h2 className="text-2xl sm:text-3xl md:text-5xl font-extrabold tracking-tight max-w-2xl leading-[1.2] sm:leading-[1.15]">
            Ready to Optimize Your Revenue Architecture?
          </h2>
          
          <p className="text-slate-300 max-w-2xl text-xs sm:text-sm md:text-base leading-relaxed font-normal antialiased">
          ...
          <div className="pt-3 sm:pt-4 flex flex-col sm:flex-row gap-3 sm:gap-4 w-full justify-center max-w-md relative z-20">
            <Link href="/contact" className="group relative bg-[#E5981A] hover:bg-[#f5a92a] text-[#0A2540] text-center font-bold tracking-wider text-[10px] sm:text-xs uppercase px-6 sm:px-8 py-3 sm:py-4 rounded-xl transition-all duration-300 shadow-xl shadow-black/20 hover:-translate-y-1 active:translate-y-0 overflow-hidden">
              <span className="relative z-10">Request Integration Demo</span>
              <span className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/30 to-white/0 -translate-x-full group-hover:translate-x-full transition-transform duration-700" />
            </Link>
            <Link href="/solutions" className="border border-white/30 hover:border-white/60 text-white text-center font-bold text-[10px] sm:text-xs uppercase tracking-wider px-6 sm:px-8 py-3 sm:py-4 rounded-xl bg-white/5 backdrop-blur-md transition-all duration-300 hover:bg-white/10 hover:-translate-y-1 active:translate-y-0">
